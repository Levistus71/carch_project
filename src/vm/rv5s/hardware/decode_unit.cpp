...
#include "vm/rv5s/hardware/decode_unit.h"
#include "vm/rv5s/hardware/decode_helper.h"
...
void DecodeUnit::DecodeInstruction(InstrContext& instr_context, RegisterFile& rf){
...
void DecodeUnit::DecodeInstrFields(InstrContext& instr_context){
...
void DecodeUnit::SetRegImmValues(InstrContext& instr_context, RegisterFile& rf){
...
void DecodeUnit::SetMemValues(InstrContext& instr_context){
...
void DecodeUnit::SetContextValues(InstrContext& instr_context) {
...
int32_t DecodeUnit::ImmGenerator(InstrContext& instr_context){
    int32_t imm = 0;
