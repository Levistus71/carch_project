...
struct AssembledProgram {
	...
	AssembledProgram() = default;
	~AssembledProgram() = default;
	AssembledProgram(const AssembledProgram& other) = default;
	AssembledProgram(AssembledProgram&& other) noexcept = default;
	AssembledProgram& operator=(const AssembledProgram& other) = default;
  	AssembledProgram& operator=(AssembledProgram&& other) noexcept = default;
};
